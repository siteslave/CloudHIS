        ...
        <div class="container">
          ...
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="<?php echo site_url();?>">หน้าหลัก</a></li>
              <li><a href="<?php echo site_url('pages/about'); ?>">เกี่ยวกับโปรแกรม</a></li>
              <li><a href="<?php echo site_url('pages/contact'); ?>">ติดต่อ</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
