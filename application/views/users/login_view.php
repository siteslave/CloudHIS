    ...
    <form class="form-actions span5">
      <div class="row">
        <div class="span5">
          ...
          <input data-name="user_name" autocomplete="off" type="text" class="span3" placeholder="ชื่อผู้ใช้งาน (Username)">
        </div>
        <div class="span5">
          <label for="">รหัสผ่าน</label>
          <input data-name="user_pass" autocomplete="off" type="password" class="span3" placeholder="รหัสผ่าน (Password)">  
        </div>
      </div>
